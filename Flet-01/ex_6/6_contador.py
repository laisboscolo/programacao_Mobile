...
# variavel que amarzena valor de contagem
    valor_contador = 0
...
# nonlocal =é usado em funções internas para permitir que uma variável da função externa seja modificada, em vez de criar uma nova variável local.
    def incrementar(e):
